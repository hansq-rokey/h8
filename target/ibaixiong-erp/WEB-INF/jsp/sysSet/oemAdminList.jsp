    	...
    	function upAdmin(status){
    		...
    		$.ajax({
 			   ...
 			   success: function(obj){
 				 	...
 				 	if ( obj.code == 0 ) {
 				 		var oemId = $("#oemId").val();
 				 		window.location.href="/sysSet/oem/adminList.html?oemId="+oemId;
 					}
 			   }
 			});
    	}
...
<div style="display: none;">
	<form action="/sysSet/oem/adminList.html" method="post">
...
<input type="hidden" id="adminId">
    <section>
        <span class="light" style="margin-top: 10px;display:inline-block"><a href="/sysSet/oem/list.html">OEM厂管理</a></span>>
        	...
        	<tbody>
        		...
        		<tr>
        			...
        			<td>
        				...
        				<a href="/sysSet/oem/userPermissionList.html?adminId=${data.admin.id }&relationId=${data.id }" class="link">详情</a>
                    </td>
        		</tr>
        		</c:forEach>
        	</tbody>
