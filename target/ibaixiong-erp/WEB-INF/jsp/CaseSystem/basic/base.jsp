...
<head>
 <title>白熊运管系统</title>
<base href="<%=basePath%>">
<link rel="icon" href="<%=basePath%>CaseSystem/basic/daowualogo.ico"
	mce_href="<%=basePath%>CaseSystem/basic/daowualogo.ico"
	type="image/x-icon">
<link rel="shortcut icon"
	href="<%=basePath%>CaseSystem/basic/daowualogo.ico"
	mce_href="<%=basePath%>CaseSystem/basic/daowualogo.ico"
	type="image/x-icon">
...
function defaultHaveScroll(gridid){ 
   ...
   // alertLayel(Ext.util.JSON.encode(opts.columns)); 
    var text='{'; 
